...
function register_acf_block_types() {
    ...
    acf_register_block_type(array(
			...
			'description'		=> __('A custom block for a call to action card.'),
			'render_template'	=> 'template-parts/sections/blocks/call-to-action/block-call-to-action.php',
			'category'			=> 'layout',
			'icon'				=> 'excerpt-view',
			'keywords'			=> array( 'call' ),
			'enqueue_style'		=> get_stylesheet_directory_uri() . '/template-parts/sections/blocks/call-to-action/block-call-to-action.css'
	));
	...
	acf_register_block_type(array(
		'name'              => 'accordion',
		'title'             => __('Accordion'),
		'description'       => __('Accordion with 3 headings and 3 descriptions'),
		'render_template'   => 'template-parts/sections/blocks/accordion/block-accordion.php',
		'category'          => 'common',
		'icon'              => 'list-view',
		'keywords'          => array( 'accordion' ),
		'enqueue_style'		=> get_stylesheet_directory_uri() . '/template-parts/sections/blocks/accordion/block-accordion.css'
	));
}
